...
<html>
  <head>
<title>检查项后台管理系统</title>
<script type="text/javascript" src="${context_path}/js/jquery-1.8.3.min.js"></script>
<link rel="stylesheet" type="text/css" href="./Wopop_files/style_log.css" />
<link rel="stylesheet" type="text/css" href="./Wopop_files/style.css" />
<link rel="stylesheet" type="text/css" href="./Wopop_files/userpanel.css" />
<link rel="stylesheet" type="text/css" href="./Wopop_files/jquery.ui.all.css" />
<link rel="stylesheet" type="text/css" href="${context_path}/plug-ins/layer/skin/layer.css"/>
<script type="text/javascript" src="${context_path}/plug-ins/layer/layer.js"></script>


<meta http-equiv="Content-Type" content="text/html; charset=utf-8" />
</head>

<body class="login" onkeydown="enter()">
<div class="login_m">
<div class="login_logo"><img src="./Wopop_files/logonago.png" width="196" height="46" /></div>
	...
	$.ajax({
		...
		success:function(ret){
			if(ret=='no'){
				...
				window.location.href = "checkproj/checkobjmain";
			}
		},
		error:function(ret){
